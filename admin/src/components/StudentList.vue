...
export default {
  ...
  async created() {
    if (this.showDocumentTaken) {
      if (AccessControl.checkRole(11)) {
        this.fields = [{key: 'proposal_is_document_taken', label: "Документы принесены"}, 'Фамилия (ребенка)', 'Имя (ребенка)', 'Отчество (ребенка)', "Дата рождения ребенка", 'Возраст ребенка', 'Имя (родителя)', 'Отчество (родителя)', 'Почта (родителя)', 'Номер телефона (родителя)', 'Действия']
      }
      else {
      ...
      if (AccessControl.checkRole(11)) {
        this.fields = ['Фамилия (ребенка)', 'Имя (ребенка)', 'Отчество (ребенка)', "Дата рождения ребенка",  'Возраст ребенка', 'Имя (родителя)', 'Отчество (родителя)', 'Почта (родителя)', 'Номер телефона (родителя)', 'Действия'];
      }
      else {
        this.fields = ['Фамилия (ребенка)', 'Имя (ребенка)', 'Возраст ребенка', 'Имя (родителя)', 'Отчество (родителя)', 'Почта (родителя)', 'Номер телефона (родителя)', 'Действия'];
      }
