...
Proposal.prototype.selectProposalsList = async function (field, arr, selections, where = "", whereData = [], userModel = null) {
    ...
    // if (selections.association && proposals.length > 0) {
    //     console.log(true);
    //     let links = {};
    //
    //     let association_ids_data = [];
    //     let association_on_select = {};
    //     let association_query = "";
    //     let i = 0;
    //     proposals.map(proposal => {
    //         if (!association_on_select[proposal.association_id]) {
    //             association_ids_data.push(proposal.association_id);
    //         }
    //         association_on_select[proposal.association_id] = true;
    //     });
    //
    //     console.log(association_on_select);
    //     console.log(association_ids_data.length)
    //
    ...
    //     const result = await associationModel.getAssociations(null, selections.association, null,"WHERE `main`.`id` IN (" + association_query + ")", association_ids_data);
    //
